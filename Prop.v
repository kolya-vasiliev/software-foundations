...
Proof. intros n. induction n. 
  simpl. apply ev_0.
  simpl. apply ev_SS in IHn. apply IHn. Qed.
...
Proof. intros n B. apply b_sum. apply B. apply b_sum. apply B.
  apply b_0.
Qed.
...
Proof. intros n m B. induction m. 
  apply b_0.
  apply b_sum. apply B. apply IHm. Qed.
...
Proof. intros n G. apply g_plus3. apply g_plus5. apply g_plus5.
  apply G. Qed.
...
Proof. intros n m Gn Gm. induction Gn as [|n'|n']. 
  apply Gm. 
  apply g_plus3. apply IHGn.
  apply g_plus5. apply IHGn. Qed.
