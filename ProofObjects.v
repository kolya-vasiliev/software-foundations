...
Theorem six_is_beautiful :
  beautiful 6.
Proof. apply b_sum with (n:=3) (m:=3).
  apply b_3. apply b_3. Qed.
...
Theorem nine_is_beautiful :
  beautiful 9.
Proof. apply b_sum with (n:=3) (m:=6).
  apply b_3. apply b_sum with (n:=3) (m:=3).
  apply b_3. apply b_3. Qed.
...
Definition b_times2': forall n, beautiful n -> beautiful (2*n) :=
  fun n => fun H => b_sum n (n+0) H (b_sum n 0 H b_0).
...
Definition gorgeous_plus13_po: forall n, gorgeous n -> gorgeous (13+n):=
  fun n => fun H => g_plus5 (5+(3+n)) (g_plus5 (3+n) (g_plus3 n H)).
...
Example trans_eq_example' : forall (a b c d e f : nat),
     ...
     [c;d] = [e;f] ->
     [a;b] = [e;f].
Proof. intros a b c d e f H H'. apply (trans_eq _ _ [c;d]).
  apply H. apply H'. Qed.
