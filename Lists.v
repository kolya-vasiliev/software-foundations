...
Proof. intros p. rewrite (surjective_pairing p). reflexivity. Qed.
...
Theorem count_add: forall v b,
  count v (add v b) = S (count v b).
Proof. intros v b. simpl. rewrite <- beq_nat_refl. reflexivity. Qed.
...
Theorem rev_snoc: forall l a,
  rev (snoc l a) = a :: rev l.
Proof. intros l a. induction l as [|n l'].
  reflexivity.
  simpl. rewrite IHl'. reflexivity. Qed.
...
Proof. intros l. induction l as [|n l'].
  reflexivity.
  simpl. rewrite rev_snoc, IHl'. reflexivity. Qed.
...
Proof. intros l1 l2 l3 l4. rewrite app_assoc, app_assoc.
  reflexivity. Qed.


Theorem snoc_append : forall (l:natlist) (n:nat),
  snoc l n = l ++ [n].
Proof. intros l n. induction l as [|m l'].
  reflexivity. 
...
Proof. intros l1 l2. induction l1 as [|n l'].
  simpl. rewrite app_nil_end. reflexivity. 
  simpl. rewrite snoc_append, snoc_append, IHl', app_assoc.
  reflexivity. Qed.
...
Proof. intros l. induction l as [|n l'].
  reflexivity. simpl. rewrite <- beq_nat_refl, IHl'. reflexivity.
Qed.
...
Proof. intros n l1 l2. rewrite snoc_append, app_assoc.
  reflexivity.
Qed.
...
Proof. intros s. induction s as [|n s'].
  reflexivity.
  simpl. destruct n.
...
Theorem count_sum: forall v b1 b2,
  count v (sum b1 b2) = count v b1 + count v b2.
Proof. intros b b1 b2. induction b1 as [|n b'].
  reflexivity. 
  simpl. rewrite IHb'. destruct (beq_nat n b).
    reflexivity. reflexivity.
Qed.
(** [] *)
...
Proof. intros l default. destruct l.
  reflexivity. reflexivity.
Qed.
